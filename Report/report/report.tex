...
\begin{itemize}
    ...
    requirement checks.
    \item \texttt{src/generate\_dashboard\_report.py}: report and plot
    generation pipeline.
\end{itemize}
...
\begin{itemize}
    ...
    \item Automated markdown report and plot generation pipeline.
\end{itemize}
...
\begin{itemize}
    ...
    \item Clone-safe commands and reproducible report generation.
...
\begin{itemize}
    \item Applen Tahu: Data Extraction, JSON Schema design, and UI Design.
    \item Malhar Patel: Graph Algorithms and UI Construction.
    \item Sankar Maharajan: Data Preprocessing and Graph Validation.
    \item Ayush: System integration, planner/report pipeline implementation,
    dashboard polish, and final report compilation.
\end{itemize}
...
\begin{itemize}
    ...
    \item \texttt{docs/reports/latest/plots/} (generated source plots)
    \item \texttt{Report/report/figs/} (submission-local copies used by this report)
\end{itemize}
...
\begin{figure}[tbp]
    ...
    \IfFileExists{./figs/graph_look_1.png}{%
        \includegraphics[width=0.95\textwidth,trim={20 260 20 10},clip]{./figs/graph_look_1.png}%
    }{%
        \IfFileExists{./figs/graph look 1.png}{%
            \includegraphics[width=0.95\textwidth,trim={20 260 20 10},clip]{./figs/graph look 1.png}%
        }{%
            \fbox{\parbox[c][0.45\textwidth][c]{0.9\textwidth}{\centering
                Missing figure:\\
                \path{./figs/graph_look_1.png}\\
                (or)\\
                \path{./figs/graph look 1.png}
            }}%
        }%
    }
    \caption{Graph look 1 (cropped for readability to remove large blank margins).}
\end{figure}
